...
from neuro_mri_xai.dataset import MRIDataset, _stratified_split_indices, get_transforms


def _make_fake_dataset(root: Path, n_per_class: int = 10, n_classes: int = 8):
...
def test_mri_dataset_loads_samples(tmp_path):
